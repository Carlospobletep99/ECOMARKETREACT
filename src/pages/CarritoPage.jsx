...
import { BsCart3, BsDash, BsPlus, BsTrash } from 'react-icons/bs';
import { useEcomarket } from '../context/EcomarketContext.jsx';

export default function CarritoPage() {
  const { cart, cartTotal, incrementQuantity, decrementQuantity, removeFromCart } = useEcomarket();
                      ...
                      <tr key={item.codigo}>
                        <td>
                          <div className="d-flex flex-column">
                            ...
                            <span className="text-muted small">Unidad de medida: {item.unidadMedida ?? 'Unidad'}</span>
                          </div>
                        </td>
                        ...
                        <td>
                          <div className="d-flex align-items-center gap-2">
                            ...
                            <span className="cart-quantity-value fw-semibold">
                              {item.cantidad}
                            </span>
                            <Button
                              variant="outline-success"
